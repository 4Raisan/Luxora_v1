      ...
      {bookings.map((booking) => {
        ...
        return (
          ...
          >
            ...
            {!compact && selected && status !== 'CANCELLED' && (
            ...
            <div className="cd-active-booking-card__actions">
              {status !== 'CANCELLED' && (
                <button
                  ...
                  onClick={() => compact ? onViewAll?.(booking.id) : onToggleDetails(booking.id)}
                >
                  {compact ? 'VIEW FULL BOOKING' : selected ? 'HIDE DETAILS' : pinUnlocked ? 'VIEW DETAILS & PIN' : 'VIEW DETAILS'}
                </button>
              )}
              {!compact && booking.providerPhone && status !== 'CANCELLED' && (
              ...
              {!compact && status === 'COMPLETED' && booking.providerName && booking.providerName !== 'Awaiting assignment' && (
